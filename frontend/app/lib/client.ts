// Code generated by the Encore v1.39.3 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-cusmato-5et2.encr.app`
}
...
/**
 * Client is an API client for the cusmato-5et2 Encore application. 
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "cusmato-5et2-Generated-TS-Client (Encore/v1.39.3)";
        }
